...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyD7NEW_IbFCg9CxlbsfP5wIrS-cP085uXo'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	var $placesRadius				= 5000;						// The radius (in meters) if search is based around a central position
	...
	function add_marker($params = array())
	{
		...
		$marker['id'] = 'GymID';										// The unique identifier of the marker suffix (ie. marker_yourID). If blank, this will default to marker_X where X is an incremental number
